...
*OAIUsersApi* | [**usersUuidSubscriptionsSubsnoUnpausePost**](docs/OAIUsersApi.md#usersuuidsubscriptionssubsnounpausepost) | **POST** /users/{uuid}/subscriptions/{subsno}/unpause | Unpause users subscription
