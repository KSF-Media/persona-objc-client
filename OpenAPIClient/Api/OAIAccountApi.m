...
-(NSURLSessionTask*) accountPasswordCheckTokenPostWithBody: (NSString*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/account/password/check-token"];
...
-(NSURLSessionTask*) accountPasswordForgotPostWithBody: (OAIForgotPasswordData*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/account/password/forgot"];
...
-(NSURLSessionTask*) accountPasswordResetPostWithBody: (OAIUpdatePasswordData*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/account/password/reset"];
