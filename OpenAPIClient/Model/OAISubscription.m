...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pricegroup", @"campaign", @"paused", @"receiver", @"deliveryAddress", @"pendingAddressChanges", @"orderNumber", @"paymentMethod", @"paymentMethodId"];
